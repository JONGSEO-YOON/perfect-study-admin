<div class="min-h-screen bg-gray-50">
    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-amber-50  rounded-lg shadow-md overflow-hidden">
            ...
            <div class="px-6 py-4 border-t border-amber-200 bg-amber-100/50">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-center p-3 bg-white rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors duration-200">
                        ...
                        <a href="{{ Storage::url($attachment) }}" target="_blank" class="text-blue-600 hover:text-blue-800 font-medium flex-1">
                            {{ basename($attachment) }}
                        </a>
                    </div>
                    @endforeach
...
function shareNotice() {
    if (navigator.share) {
        navigator.share({
            title: '{{ $notice->title ?? "학생 공지" }}',
            text: '{{ Str::limit($notice->content ?? "학생 공지 내용", 100) }}',
