<div class="min-h-screen">
  ...
  <!-- Main Content Area -->
    <main class="max-w-6xl mx-auto px-2 sm:px-6 lg:px-8 py-2 sm:py-8">
        <div class="bg-fuchsia-50 p-3 sm:p-4 rounded-lg shadow-sm mb-4">
             ...
             <div class="overflow-x-auto">
                @forelse ($weeklyReports as $weekReport)
                        ...
                        <div class="">
                            ...
                            @if ($weekReport['test_report'])
                                <div class="mb-8">
                                    <div class="flex items-center mb-4 p-6">
                                        ...
                                        <h3 class="text-lg font-bold text-stone-800">{{ $weekReport['week_label'] }} 주간테스트</h3>
                                    </div>
                            ...
                            @if ($weekReport['homework_report'])
                                <div class="mb-8">
                                    <div class="flex items-center mb-4 p-6">
                                        ...
                                        <h3 class="text-lg font-bold text-stone-800">{{ $weekReport['week_label'] }} 주간숙제</h3>
                                    </div>
                                    <div class="overflow-x-auto border-t border-stone-200">
                                        <table class="w-full table-auto border-collapse border border-stone-200 rounded-lg overflow-hidden">
                                    <thead>
                            ...
                            <div class="mb-4 p-6">
                                <div class="flex items-center mb-4">
                                    ...
                                    <h3 class="text-lg font-bold text-stone-800">{{ $weekReport['week_label'] }} 강사 코멘트</h3>
                                </div>
                    ...
                    @if (!$loop->last)
                        <div class="flex items-center justify-center my-8">
                            ...
                            <div class="w-32 h-px bg-gradient-to-l from-transparent via-stone-300 to-transparent"></div>
                        </div>
                    @endif
                ...
                @empty
                    <div class="text-center py-12">
                        ...
                        <p class="text-stone-500 text-sm">선택하신 기간에 해당하는 주간 보고서가 없습니다.</p>
                    </div>
                @endforelse
