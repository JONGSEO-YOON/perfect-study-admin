<div class="min-h-screen">
    ...
    <main class="max-w-6xl mx-auto px-2 sm:px-4 lg:px-6 py-2 sm:py-4">
        ...
        <!-- 환불정책 링크 -->
        <div class="mb-4 text-right px-2">
            <a href="{{ route('parent.refund-policy') }}" wire:navigate class="inline-flex items-center text-xs text-stone-500 hover:text-stone-700 underline">
