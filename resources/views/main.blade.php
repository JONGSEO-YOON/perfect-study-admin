                ...
                <div class="flex-1 overflow-auto ">
                    <div class="flex flex-col px-5 py-4 gap-y-4 max-w-[740px] mx-auto w-full">
                        @foreach ($testsheets as $testsheet)
                            <div
                                class="hidden md:flex rounded-[10px] border-[#E9E9E9] border py-7 px-5 flex-row items-center">
                                <div
                                ...
                                <h1 class="font-semibold ml-4 w-12 break-all">
                                ...
                                <div class="flex flex-col gap-y-1">
                                    ...
                                    <div
                                        ...
                                        @else
                                            <span><span
                                                    class="text-[#7256C2] font-bold">0</span>/{{ count($testsheet->questions) }}</span>
                                        @endif
                                    </div>
                                </div>
                                @if ($testsheet->latestUserAnswer)
                            ...
                            <div class="rounded-[10px] border-[#E9E9E9] border py-4 px-5 flex flex-col md:hidden">
                                ...
                                <div class="flex flex-col gap-y-1 mt-4 px-2">
                                    <div
                                        class="hidden font-medium text-sm text-[#7D7D92] flex flex-row justify-between gap-x-4">
                                        마감 기한
                                        <span><span class="text-[#F86363] font-bold mr-1">2</span>일남음</span>
                                    </div>
                                    <div
