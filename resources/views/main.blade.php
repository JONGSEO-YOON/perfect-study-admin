        ...
        <div class="flex-1 flex flex-col">
            ...
            <div class="flex-1 flex flex-col">
                <div class="border-b flex flex-row px-5 gap-x-1">
                    <a href="#"
                        class="text-xl md:text-2xl border-b-[3px] border-[#7256C2] py-2.5 md:py-4 font-bold px-3">
                        시험
                    </a>
                    <a href="#" class="text-xl md:text-2xl md:py-4 py-2.5 font-semibold px-3 text-[#A3A3A3]">
                        숙제
                    </a>
                </div>
                <div class="flex-1 overflow-auto ">
                    <div class="flex flex-col px-5 py-4 gap-y-4 max-w-[740px] mx-auto w-full">
                        {{-- <div class="rounded-[10px] border-[#E9E9E9] border py-7 px-5 flex flex-row items-center">
                            <div
                            ...
                            <h1 class="font-semibold ml-4 w-20 break-all">
                                일일 TEST
                            </h1>
                            <div class="flex flex-col ml-6 gap-y-1.5 flex-1">
                                <h1 class="font-bold">09월 13일 (수학(상))</h1>
                            ...
                            <div class="flex flex-col gap-y-1">
                                ...
                                <div class="font-medium text-sm text-[#7D7D92] flex flex-row justify-between gap-x-4">
                                    풀이된 문제
                                    <span><span class="text-[#7256C2] font-bold ">9</span>/14</span>
                                </div>
                            </div>
                            <button
                                class="flex flex-row items-center justify-center py-2.5 px-7  font-semibold bg-[#F4F4F4] rounded-[5px] gap-x-3 ml-4">
                        ...
                        @for ($i = 0; $i < 10; $i++)
                            <div
                                class="rounded-[10px] border-[#E9E9E9] border py-7 px-5 flex-row items-center hidden md:flex ">
                                <div
                                    class="rounded-full h-[56px] w-[56px] bg-[#8570C2] text-white  text-center p-1.5 leading-tight font-medium flex items-center justify-center">
                                    수학(상)
                                </div>
                                ...
                                <div class="flex flex-col gap-y-1">
                                    <div
                                        class="font-medium text-sm text-[#7D7D92] flex flex-row justify-between gap-x-4">
                                        마감 기한
                                        <span><span class="text-[#F86363] font-bold mr-1">2</span>일남음</span>
                                    </div>
                                    <div
                                ...
                                <button
                                    class="flex flex-row items-center justify-center py-2.5 px-7 text-white font-semibold bg-[#7256C2] rounded-[5px] gap-x-3 ml-4">
                                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M12.106 5.23521C12.4262 5.40549 12.694 5.65967 12.8808 5.97054C13.0676 6.2814 13.1663 6.63722 13.1663 6.99988C13.1663 7.36254 13.0676 7.71836 12.8808 8.02922C12.694 8.34008 12.4262 8.59427 12.106 8.76455L3.56467 13.4092C2.18933 14.1579 0.5 13.1845 0.5 11.6452V2.35521C0.5 0.815213 2.18933 -0.157454 3.56467 0.589879L12.106 5.23521Z"
                            ...
                            <div class="rounded-[10px] border-[#E9E9E9] border py-4 px-5 flex flex-col md:hidden">
                                ...
                                <button
                                    class="flex flex-row items-center justify-center py-2.5 px-7 text-white font-semibold bg-[#7256C2] rounded-[5px] gap-x-3 mt-4">
                                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M12.106 5.23521C12.4262 5.40549 12.694 5.65967 12.8808 5.97054C13.0676 6.2814 13.1663 6.63722 13.1663 6.99988C13.1663 7.36254 13.0676 7.71836 12.8808 8.02922C12.694 8.34008 12.4262 8.59427 12.106 8.76455L3.56467 13.4092C2.18933 14.1579 0.5 13.1845 0.5 11.6452V2.35521C0.5 0.815213 2.18933 -0.157454 3.56467 0.589879L12.106 5.23521Z"
