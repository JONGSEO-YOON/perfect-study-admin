...
<template>
    <div class="folder-tree-item">
        <div
            :class="[
                'flex items-center flex-row px-5 py-2.5 hover:bg-gray-100 cursor-pointer transition-all text-gray-700 group',
        ...
        >
            ...
            <h1 class="flex-1 ml-4 font-semibold text-lg">{{ item.name }}</h1>
            ...
            <div
                class="hidden group-hover:block text-primary-500"
